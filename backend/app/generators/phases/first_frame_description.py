...
from app.generators.prompts.text_to_video import FIRST_FRAME_DESCRIPTION_SYSTEM_PROMPT as TEXT_TO_VIDEO_FIRST_FRAME_DESC_PROMPT
...
class FirstFrameDescriptionGenerator(Generator):
    ...
    def __init__(self, request: ArkChatRequest, mode: Mode.NORMAL):
        ...
        if content_mode == MODE_INSURANCE_CASE:
            ...
            self.system_prompt = TEXT_TO_VIDEO_FIRST_FRAME_DESC_PROMPT
        else:
