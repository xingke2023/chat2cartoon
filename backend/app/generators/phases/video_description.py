...
from app.generators.prompts.insurance_case import VIDEO_DESCRIPTION_SYSTEM_PROMPT as INSURANCE_VIDEO_DESC_PROMPT
...
class VideoDescriptionGenerator(Generator):
    ...
    def __init__(self, request: ArkChatRequest, mode: Mode.NORMAL):
        ...
        self.mode = mode
        self.system_prompt = INSURANCE_VIDEO_DESC_PROMPT if content_mode == MODE_INSURANCE_CASE else VIDEO_DESCRIPTION_SYSTEM_PROMPT
