...
from app.constants import MAX_STORY_BOARD_NUMBER_NARRATION as MAX_STORY_BOARD_NUMBER
...
- 故事内容贴合主题，情节完整，有起承转合。
- 故事按语义自然分段，每段对应一个画面（分镜），【必须恰好{MAX_STORY_BOARD_NUMBER}段，不多不少】。
...
- 必须分段，每段单独一行，段落之间空行。
- 分段以语义为准，不要在句子中间断开。
- 【严格限制】故事只能有{MAX_STORY_BOARD_NUMBER}段，超出部分必须合并。

## 示例输出：
phase=Script
《小红帽的故事》

从前，有个可爱的小女孩，大家都叫她小红帽，因为她总戴着一顶红色的帽子。妈妈每天叮嘱她要乖乖听话，不要和陌生人说话。一天，妈妈让小红帽去外婆家送篮子，小红帽背上篮子，蹦蹦跳跳地出发了。

小红帽走进大森林，遇见了一只大灰狼。外婆看见小红帽平安到来，紧紧抱住她说："聪明的孩子，记住不要和陌生人说话！"两人快乐地享用了一顿温馨的下午茶。

角色1：小红帽，可爱小女孩，头戴红色帽子（森林小路）
角色2：外婆，慈祥的老奶奶，白发眼镜（外婆的小屋）
"""
)
